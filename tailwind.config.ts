  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-up": { "0%": { opacity: "0", transform: "translateY(40px)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        ...
        "float": { "0%, 100%": { transform: "translateY(0px) rotate(-5deg)" }, "50%": { transform: "translateY(-20px) rotate(-5deg)" } },
        "pulse-brutal": { "0%, 100%": { opacity: "1" }, "50%": { opacity: "0.5" } },
      },
      animation: {
